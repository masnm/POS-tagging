...
class Verbal_Adjective_Finder ( CSV_File_To_List, CSV_File_To_List_Of_List, Tag_Using_Word_List, Tag_Using_Suffix_List, Tag_Using_Prefix_Suffix_List ):

    verbal_adjective_suffix_lst_file = "src/CSV_files/_____.csv"
    word_pos = []
    verbal_adjective_suffix_list = []
    ...
    def __init__ ( self, word_pos:Word_POS_List ):
        ...
        self.verbal_adjective_suffix_list = self.file_to_list ( self.verbal_adjective_suffix_lst_file, "verbal_Adjective" )
